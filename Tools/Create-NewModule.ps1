...
New-Item -ItemType Directory -Path "$BasePath\Public" | Out-Null
New-Item -ItemType Directory -Path "$BasePath\Private"  | Out-Null
$ToolsPath = New-Item -ItemType Directory -Path "$BasePath\Tools"
